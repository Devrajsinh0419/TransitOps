...
export default function SettingsError({ error, reset }: ErrorProps) {
  React.useEffect(() => {
    console.error('Settings module error occurred:', error);
  }, [error]);
    ...
    <div className="select-none text-center p-12 border border-dashed border-border/50 rounded-2xl max-w-md mx-auto space-y-4 my-12">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground leading-normal">
          An unexpected error occurred while parsing visual preferences or access policies. Please check local storage configuration.
        </p>
      </div>
