  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Schedule routine servicing, track repair operations, and inspect vehicle safety compliance"
      >
      ...
      <div className="border border-border bg-card rounded-2xl p-6 shadow-soft max-w-3xl mx-auto">
        <div className="flex items-center gap-3 pb-4 border-b border-border/60 mb-5">
          ...
          <div>
            <h3 className="font-semibold text-foreground text-base">Maintenance Module Architecture</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="font-mono text-[10px] text-muted-foreground bg-muted p-2.5 rounded-lg space-y-1.5">
                <div>• maintenanceService.getAll(params)</div>
                <div>• maintenanceService.getById(id)</div>
                <div>• maintenanceService.create(data)</div>
                <div>• maintenanceService.update(id, data)</div>
                <div>• maintenanceService.delete(id)</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="font-mono text-[10px] text-muted-foreground bg-muted p-2.5 rounded-lg space-y-1.5">
                <div>• Type: <span className="text-foreground">MaintenanceRecord</span></div>
                <div>• Type: <span className="text-foreground">MaintenanceType</span></div>
                <div>• Status: <span className="text-foreground">MaintenanceStatus</span></div>
              </div>
            </div>
          </div>
