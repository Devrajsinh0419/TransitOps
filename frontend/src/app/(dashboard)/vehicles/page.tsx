  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Monitor, update, and manage your fleet inventory"
      >
      ...
      {/* Architectural Checklist & Blueprint */}
      <div className="border border-border bg-card rounded-2xl p-6 shadow-soft max-w-3xl mx-auto">
        <div className="flex items-center gap-3 pb-4 border-b border-border/60 mb-5">
          ...
          <div>
            <h3 className="font-semibold text-foreground text-base">Vehicles Module Architecture</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="font-mono text-[10px] text-muted-foreground bg-muted p-2.5 rounded-lg space-y-1.5">
                <div>• vehicleService.getAll(params)</div>
                <div>• vehicleService.getById(id)</div>
                <div>• vehicleService.create(data)</div>
                <div>• vehicleService.update(id, data)</div>
                <div>• vehicleService.delete(id)</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="font-mono text-[10px] text-muted-foreground bg-muted p-2.5 rounded-lg space-y-1.5">
                <div>• Type: <span className="text-foreground">Vehicle</span></div>
                <div>• Status: <span className="text-foreground">VehicleStatus</span></div>
                <div>• Fuel: <span className="text-foreground">FuelType</span></div>
              </div>
            </div>
          </div>
